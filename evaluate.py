...
def cal_summac(preds, docs):
  ...
  score = model_zs.score(docs, preds)['scores']
  print(score)
...
def evaluate(pred_path, gold_path):
  ...
  score_dict['ROUGE_AVG'] =  (rouge1_score + rouge2_score + rougel_score)/3
...
# submit_dir = 'output_dir_llama'
submit_dir = 'output_dir_gpt'
truth_dir = 'truth_dir'
